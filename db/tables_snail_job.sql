...
CREATE TABLE `snail_job_log_report`
(
    `id`            int(11) NOT NULL AUTO_INCREMENT,
...
-- 工作节点注册
CREATE TABLE `snail_job_registry`
(
    `id`             int(11)      NOT NULL AUTO_INCREMENT,
...
# INSERT INTO `snail_job_group`(`id`, `app_name`, `title`, `address_type`, `address_list`)
# VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, NULL);
# INSERT INTO `snail_job_info`(`id`, `job_group`, `job_cron`, `job_desc`, `add_time`, `update_time`, `author`,
...
# INSERT INTO `snail_job_user`(`id`, `username`, `password`, `role`, `permission`)
# VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, NULL);
INSERT INTO `snail_job_lock` (`lock_name`)
