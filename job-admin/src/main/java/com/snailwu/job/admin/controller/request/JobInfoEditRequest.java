...
public class JobInfoEditRequest {
    ...
    public JobInfo convertToJobInfo() {
        ...
        jobInfo.setExecRouteStrategy(this.executorRouteStrategy);
        jobInfo.setExecHandler(this.executorHandler);
        jobInfo.setExecParam(this.executorParam);
        jobInfo.setExecTimeout(this.executorTimeout);
        jobInfo.setExecFailRetryCount(this.executorFailRetryCount);
        return jobInfo;
    }
